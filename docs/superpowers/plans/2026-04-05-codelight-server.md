...
**Goal:** Build a clean Fastify/TypeScript server that relays E2E encrypted Claude Code session data between CodeIsland (macOS) and CodeLight (iPhone) via Socket.io.
